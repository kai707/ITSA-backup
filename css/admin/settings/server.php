...
$temp->add(new admin_setting_configtext('smtpport', get_string('smtpport', 'admin'), get_string('configsmtpport', 'admin'), '25', PARAM_NOTAGS));
$temp->add(new admin_setting_configselect('smtpsecure', get_string('smtpsecure', 'admin'), get_string('configsmtpsecure', 'admin'), '', array(''=>'no secure','ssl'=>'ssl','tls'=>'tls') ));
