<?php // $Id: insert_sound.php,v 3.0 2008/08/13 00:00:00 gibson Exp $
...
<body onload="Init()">
  ...
  <form action="" method="get" id="first" onsubmit="return false">
    <div style="text-align: center">
      ...
      <div class="space"></div>
      <div style="text-align: center">
      <applet archive="nanogong.jar" code="gong.NanoGong" id="recorder" name="recorder" width="180" height="40"></applet>
      </div>
      </fieldset>
      </center>
    </div>
