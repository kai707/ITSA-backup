<?PHP // $Id$ 
      // grades.php - created with Moodle 1.9.4+ (Build: 20090401) (2007101545.01)
...
$string['aggregateoutcomeshelp'] = '在成績彙總中包含能力指標可能無法得到想要的所有成績，您可以選擇包含或不包含它們。';
...
$string['configdisablegradehistory'] = '關閉成績相關表格中變動的歷史紀錄，這樣可以些微加速伺服器的速度，以及節省資料庫的空間。';
$string['configenableajax'] = '增加AJAX功能至成績單中，將簡化和加速操作。這取決於使用者瀏覽器的Javascript功能是否啟用。';
$string['configenableoutcomes'] = '支援能力指標（也稱為能力、目標、規範或標準）意味著我們可以使用一個或多個繫結於能力指標的量尺。啟動能力指標將可在整個網站中使用此特別的評分方法。';
$string['configexportdecimalpoints'] = '輸出報表顯示小數點位數，可在輸出時另外設定。';
$string['configgradeboundary'] = '百分比範圍將指定一個等級。（如果字母評分顯示類型啟用）';
...
$string['configgradeletter'] = '字母或其他符號用來表示成績的等第。';
$string['configgradeletterdefault'] = '字母或其他符號用來表示成績的等第。如果留空，則使用網站預設的（目前是{$a}）。';
...
$string['confighiddenasdate'] = '如果用戶無法看到隱藏的成績所顯示的時間，則使用\"-\"代替。';
...
$string['configrangesdisplaytype'] = '指定如何顯示等第，如果選擇了繼承選項，每列中將套用顯示的類型。';
...
$string['disablegradehistory'] = '停用成績歷史紀錄';
...
$string['encoding'] = '編碼';
$string['errorcalculationnoequal'] = '公式必須以等號開頭(=1+2)';
...
$string['gradeoutcomeitem'] = '能力指標成績';
...
$string['hidden'] = '隱藏';
$string['hiddenasdate'] = '隱藏的成績要顯示提出日期';
...
$string['importskippednomanagescale'] = '您沒有權限新增一個量尺，所以能力指標\"{$a}\"將略過，因為它需要建立一個新量尺。';
$string['importskippedoutcome'] = '簡稱為\"{$a}\"的能力指標已經存在。檔案匯入後這個將被略過。';
...
$string['letterreal'] = '等第(真實)';
$string['letters'] = '等第';
$string['linkedactivity'] = '已連結的活動';
$string['linkedactivityhelp'] = '指定一個連結到能力指標項目的活動選項。用來測量無法使用量規評價的學生表現。';
$string['lock'] = '鎖定';
$string['locked'] = '鎖定';
$string['locktime'] = '鎖定從';
...
$string['noforce'] = '不強制';
$string['nogradeletters'] = '沒有設成績等第';
$string['nogradesreturned'] = '沒有成績資料';
$string['noidnumber'] = '沒有ID號碼';
$string['nolettergrade'] = '沒有等第給';
$string['nomode'] = '無';
...
$string['outcomeidhelp'] = '指定將在成績單中顯示的能力指標。只有平台啟用及和課程相關的能力指標才可使用。';
$string['outcomeitem'] = '能力指標項';
$string['outcomeitemsedit'] = '編輯能力指標';
$string['outcomename'] = '能力指標名稱';
$string['outcomereport'] = '能力指標報表';
$string['outcomes'] = '能力指標';
$string['outcomescourse'] = '課程中已使用的能力指標';
...
$string['outcomestandardhelp'] = '標準能力指標在整個網站的所有課程中都可以使用。';
...
$string['rawpct'] = '原始%%';
$string['real'] = '真實的';
$string['realletter'] = '真實(等第)';
$string['realpercentage'] = '真實(百分比)';
