...
$string['configdisablecourseajax'] = '當編輯課程主頁的時候不使用AJAX。';
...
$string['configemoticons'] = '更改左邊的程式碼，它與右邊的表情名稱相關。若要增加新的表情符號時，需先新增一行程式碼和一個名稱(name)，然後在 /pix/s目錄中加表情圖片(檔名為name.gif)。';
...
$string['configenableglobalsearch'] = '這個設定啟用資源與活動的全文檢索功能，但是與PHP4不相容。';
$string['configenablegroupings'] = '這個設定啟用群組的再分組功能。';
$string['configenablehtmlpurifier'] = '使用HTML過濾器取代KSES來清理不受信任的文字。HTML過濾器被認為是更安全的，但是會對更多的資源文字資訊敏感。。請注意嵌入(embed)及物件(object)標籤無法使用，也不支援MathML標籤和舊版的語言(lang)標籤。';
...
$string['configenrolmentplugins'] = '請選擇您要使用的選課外掛套件，別忘記要適當的做好設定。<br /><br />您必須指出要啟動那個選課外掛，而且只能有<strong>一個</strong>設為預設<em>互動式</em>選課註冊。欲取消互動式選課，請在課程中設定\"可註冊\"為\"否\"。';
...
$string['confignonmetacoursesyncroleids'] = '所有加選子課程的使用者預設會同步到共同課程，在這裡選擇的角色不會包含在同步處理中。';
...
$string['configsendcoursewelcomemessage'] = '若啟用，則用戶自行選課後，會收到電子郵件傳送的歡迎訊息。';
...
$string['enablehtmlpurifier'] = '啟用HTML過濾器';
...
$string['langpackinstalled'] = '語言包{$a}已經成功安裝好。';
$string['langpackmaintaining'] = '維護語言包';
$string['langpackremoved'] = '成功移除語言';
$string['langpacks'] = '語言包';
$string['langpackupdated'] = '已經成功更新{$a}語言包了';
$string['langpackupdateskipped'] = '{$a}語言包的更新已略過不進行';
...
$string['nonmetacoursesyncroleids'] = '不能同步到共同課程的角色';
...
$string['numberofstrings'] = '總共字句數：{$a->strings}<br/>缺少：{$a->missing}({$a->missingpercent}&nbsp;%%)';
...
$string['profilefieldtypecheckbox'] = '核取方塊';
...
$string['uploadpicture_cannotunzip'] = '無法解壓縮相片檔';
$string['uploadpicture_invalidfilename'] = '相片檔{$a}的檔名中有無效的字元，略過。';
$string['uploadpicture_overwrite'] = '覆蓋已經存在的用戶相片嗎？';
$string['uploadpicture_userfield'] = '相片檔名採用何項用戶屬性：';
$string['uploadpicture_usernotfound'] = '用戶欄位\"{$a->userfield}\" 值\"{$a->uservalue}\"不存在，略過。';
$string['uploadpicture_userskipped'] = '略過使用者{$a} (已經有相片了)';
$string['uploadpicture_userupdated'] = '用戶{$a}的相片已經更新。';
$string['uploadpictures'] = '上傳用戶相片';
$string['uploaduserspreview'] = '批次增修用戶的預覽';
$string['uploadusersresult'] = '批次增修用戶的結果';
$string['upwards'] = '向上';
...
$string['configsmtpport'] = '與SMTP主機連線埠號，當您使用Secure 模式連線時，您連線的Port 可能為 465';
$string['smtpsecure'] = 'SMTP Secure 模式'; 
$string['configsmtpsecure'] = '部份SMTP主機將要求使用 Secure模式連線，支援的模式有ssl或tls'; 
