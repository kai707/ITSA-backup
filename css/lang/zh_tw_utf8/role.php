<?PHP // $Id$ 
      // role.php - created with Moodle 1.9.4+ (Build: 20090401) (2007101545.01)
...
$string['category:visibility'] = '檢視隱藏的類別';
$string['course:activityvisibility'] = '隱藏/顯示活動';
$string['course:bulkmessaging'] = '可發送訊息給多人';
$string['course:changefullname'] = '變更課程全名';
$string['course:changeidnumber'] = '變更課程識別號碼';
$string['course:changeshortname'] = '課程簡稱';
...
$string['role:safeoverride'] = '為其他人置換安全範圍內的權限';
...
$string['safeoverridenotice'] = '注意：高風險的能力已鎖住禁用，因為只允許您置換安全範圍內的權限。';
