<?PHP // $Id$ 
      // chat.php - created with Moodle 1.9.4+ (Build: 20090401) (2007101545.01)
...
$string['messageenter'] = '{$a}剛加入聊天室';
$string['messageexit'] = '{$a}離開聊天室';
$string['messages'] = '訊息';
$string['method'] = '聊天方式';
$string['methoddaemon'] = '聊天伺服器的daemon';
...
$string['notallowenter'] = '不允許您進入這聊天室。';
$string['oldping'] = '逾時斷線';
