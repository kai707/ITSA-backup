<?PHP // $Id$ 
      // question.php - created with Moodle 1.9.4+ (Build: 20090401) (2007101545.01)
...
$string['cwrqpfs'] = '從子類別中隨機選擇試題。';
$string['cwrqpfsnoprob'] = '由於沒有試題類別，影響到\"從子類別中隨機選擇試題\"的執行。';
$string['defaultfor'] = '{$a}的預設題庫';
$string['defaultinfofor'] = '課程：{$a}所分享的試題類別。';
$string['donothing'] = '不要複製或移動檔案或改變連結';
$string['editingcategory'] = '編輯類別';
$string['editingquestion'] = '編輯試題';
$string['erroraccessingcontext'] = '無法存取上下文';
...
$string['moveq'] = '搬移試題';
$string['moveqtoanothercontext'] = '搬移試題至其他上下文中';
...
$string['upgradeproblemcouldnotupdatecategory'] = '無法升級試題類別 {$a->name} ($a->id)';
$string['upgradeproblemunknowncategory'] = '在升級試題類別時遇到錯誤。分類{$a->id}引用了它的父類別{$a->parent}，而該分類已經不存在了。已透過修改其父類別來糾正錯誤。';
$string['yourfileshoulddownload'] = '您的匯出檔案應該很快就開始下載，如果沒有動靜，請 <a href=\"{$a}\">點按這裡</a> 手動下載。';
