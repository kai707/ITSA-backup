<?PHP // $Id$ 
      // forum.php - created with Moodle 1.9.4+ (Build: 20090401) (2007101545.01)
...
$string['aggregateavg'] = '評分的平均';
$string['aggregatecount'] = '評分的數量';
$string['aggregatecountformat'] = '{$a->count}(成績:{$a->grade})';
$string['aggregatemax'] = '最大評分';
$string['aggregatemin'] = '最小評分';
$string['aggregatenone'] = '不計成績';
$string['aggregatesum'] = '評分的總合';
$string['aggregatetype'] = '整合類型';
$string['ajaxrating'] = '啟用AJAX評比功能';
...
$string['configajaxrating'] = 'AJAX 評比可以增強討論區評比系統的可用性。若開啟，則用戶在評比時無需到頁面底部點擊的評比按鈕。在網站和用戶的 AJAX 選項均開啟時此功能才能生效。';
...
$string['configlogblocked'] = '討論區重整可能會紀錄到嘗試傳送電子郵件給關閉email的帳戶的資訊。';
...
$string['invalidrate'] = '無效的評比{$a}';
$string['lastpost'] = '最新文章';
$string['learningforums'] = '學習型討論區';
$string['logblocked'] = '在日誌中記錄鎖定的email';
...
$string['noguestsubscribe'] = '抱歉,訪客不允許訂閱而且不能透過郵件收到發表內容';
...
$string['unsubscribeallconfirm'] = '您訂閱了{$a}討論區，您確認要取消所有討論區的訂閱和取消自動訂閱嗎？';
$string['unsubscribealldone'] = '您所有的訂閱已被取消，但仍能收到強制訂閱的資料。如果您不想收到本網站的任何資料，請更改您個人資料。';
$string['unsubscribeallempty'] = '抱歉，您沒有訂閱任何討論區，如果您不想收到本網站的任何資料，請更改您個人資料。';
