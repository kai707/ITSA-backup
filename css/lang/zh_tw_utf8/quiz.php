...
$string['addingrandom'] = '新增隨機題';
$string['addingrandomsamatch'] = '新增隨機簡答配合題';
$string['addingshortanswer'] = '新增簡答題';
$string['addingtruefalse'] = '新增是非題';
...
$string['changessavedwitherrors'] = '當儲存成績的變動時，發生了一些錯誤。';
...
感謝您在{$a->submissiontime}將{$a->quizname}測驗的答案繳交到\"{$a->coursename}\"課程中。

這封郵件確認我們已經接收到您的作答。

您可以連線至 {$a->quizurl} 檢閱此測驗。';
...
$string['functiontakesatleasttwo'] = '函數{$a}必須至少有兩個參數';
$string['functiontakesnoargs'] = '函數{$a}不需要任何參數';
$string['functiontakesonearg'] = '函數{$a}必須只有一個參數';
$string['functiontakesoneortwoargs'] = '函數{$a}必須有一個或兩個參數';
$string['functiontakestwoargs'] = '函數{$a}必須有兩個參數';
$string['generalfeedback'] = '一般的回饋';
$string['generatevalue'] = '產生一個數，介於';
...
$string['giftnovalidquestion'] = '找不到可用的試題';
$string['giftqtypenotset'] = '試題類型沒有設定';
...
$string['gradingdetails'] = '本次得分：{$a->raw}/{$a->max}。';
$string['gradingdetailsadjustment'] = '加上先前的倒扣，本題得到<strong>{$a->cur}/{$a->max}</strong>分。';
...
$string['importparseerror'] = '在分析匯入的檔案時發生錯誤，因此並未匯入任何試題。若只想匯入正確的試題，請將\"發生錯誤就停止\"這項設定為\"否\"，並重新再匯入。';
...
$string['min'] = '最小';
$string['minutes'] = '分';
$string['missinganswer'] = '在位於第{$a}行的試題中，:ANSWER、:Lx 和 :Rx語句太少了。您需要定義至少兩個答案。';
...
$string['nogradewarning'] = '因為這個測驗不評分，所以您無法依分數設定總回饋。';
...
$string['numattempts'] = '{$a->studentnum}位{$a->studentstring}已經作答{$a->attemptnum}次';
...
$string['questioninuse'] = '這題\"{$a->questionname}\"正被下列測驗卷使用中：<br />{$a->quiznames}<br />，因此只能從類別中刪除此題，而不能從測驗中刪除。';
...
$string['randomsamatchnumber'] = '待選題數';
...
$string['savedfromdeletedcourse'] = '從已刪除的課程\"{$a}\"儲存下來';
$string['savegrades'] = '儲存成績';
$string['savemyanswers'] = '儲存我的解答';
$string['savenosubmit'] = '儲存但還不交卷';
$string['savequiz'] = '儲存整份測驗';
$string['score'] = '原始分數';
$string['scores'] = '分數';
$string['select'] = '選擇';
$string['selectall'] = '全選';
...
$string['viewallreports'] = '檢視{$a}次作答的報表';
...
$string['xmltypeunsupported'] = 'XML匯入不支援{$a}題目型態';
