<?PHP // $Id$ 
      // error.php - created with Moodle 1.9.4+ (Build: 20090401) (2007101545.01)
...
$string['cannotinsertrecord'] = '不能插入新記錄ID {$a}';
...
$string['countriesphpempty'] = '錯誤：語言包{$a}中的 countries.php 檔案是空的或是遺失。';
...
$string['errorsavingrequest'] = '在儲存您的申請時發生了錯誤。';
...
$string['guestsarenotallowed'] = '不允許訪客用戶這麼做';
$string['invalidadminsettingname'] = '無效的管理設定($a)';
$string['invalidcontext'] = '無效的關聯';
$string['invalidcourse'] = '無效的課程';
$string['invalidcourseid'] = '您正試著要使用一個無效的課程編號($a)';
...
$string['invalidsesskey'] = '錯誤的sesskey，表單未被接收。';
...
$string['socksnotsupported'] = 'PHP4 不支持 SOCKS5 proxy 代理';
$string['statscatchupmode'] = '統計資料目前在 catchup 模式，{$a->daysdone}天內的資料已經處理， {$a->dayspending} 天的資料等候中。請稍後再檢查。！';
...
$string['usernotaddedregistered'] = '使用者未加入- 該帳號已註冊';
...
$string['youcannotdeletecategory'] = '您不能刪除分類\"{$a}\"，因為您無權刪除其內容或將它們搬移到其他地方。';
