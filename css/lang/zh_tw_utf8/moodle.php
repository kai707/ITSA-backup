...
$string['addedtogroup'] = '已分到{$a}組';
$string['addedtogroupnot'] = '未加入{$a}組';
$string['addedtogroupnotenrolled'] = '未加入{$a}組，因為並未選修該課程';
...
$string['adminhelpmymoodle'] = '為用戶的\"我的Moodle\"設置區塊';
...
$string['backupfromthissite'] = '這個網站做備份嗎？';
$string['backupgradebookhistoryhelp'] = '如果啟用，則成績紀錄將包含在自動備份中。請注意，為了執行此工作，在(主機->清除)的(停用成績的歷史紀錄)設定，不可以停用。';
...
$string['coursehelpcategory'] = '排列課程在課程清單的位置，以便學生容易找到它。';
...
$string['coursehelpmetacourse'] = '設定為元課程。元課程是由子課程註冊選課（及角色指派）。';
$string['coursehelpnewsitemsnumber'] = '最近出現在課程首頁的項目，將列在右手邊的最新消息區塊中。<br/>(0代表不顯示)';
$string['coursehelpnumberweeks'] = '在課程主頁上，顯示的週次數或主題數。';
$string['coursehelpshowgrades'] = '啟用顯示成績簿。這無法預防成績被顯示在個別的活動中。';
...
$string['editremoteprofile'] = '編輯遠端的個人資料';
...
如果您需要協助，請聯絡網站管理員，
{$a->admin}';
$string['emailpasswordconfirmationsubject'] = '{$a}：確變更密碼的確認';
...
$string['enrolmentnotyet'] = '抱歉,在{$a}之前您無法使用這個課程';
...
您可以透過下面網址來延長他們的修課期限：{$a->extendurl}';
...
$string['grades'] = '成績';
$string['group'] = '分組';
$string['groupadd'] = '增加新的分組';
$string['groupaddusers'] = '將選擇的目標，加入分組';
...
$string['includeuserfiles'] = '包含用戶的檔案';
$string['info'] = '資訊';
...
<p>假如您所選定 帳號名稱已經有人先登記 則需要輸入新的名稱。</p>';
...
$string['markthistopic'] = '將本主題設定為目前教學主題';
...
$string['moodledocslink'] = '本頁的 Moodle 線上文件';
...
$string['pathslasherror'] = '路徑不能用斜線\"/\"結尾';
$string['paymentinstant'] = '使用以下按鈕立即付款及註冊。';
$string['paymentpending'] = '（<small><b><u>{$a}</u></b> 等待中</small>）';
$string['paymentrequired'] = '這個課程需要付費才能進入。';
$string['payments'] = '付款';
$string['paymentsorry'] = '謝謝您的繳費!不幸地您的繳費沒有完全處理完成，而且您還沒到課程\"{$a->fullname}\"註冊。請稍後再嘗試繼續課程，但假如您仍然有問題，請通知{$a->teacher}老師或網站管理員。';
...
$string['preprocessingbackupfile'] = '預先處理備份的檔案';
$string['preview'] = '預覽';
...
$string['profile'] = '簡歷';
$string['profilenotshown'] = '直到這個人至少註冊一門課程，個人簡歷才會顯示出來。';
...
$string['rename'] = '改名';
$string['renamefileto'] = '將<b>{$a}</b>重新命名為';
$string['report'] = '報表';
$string['reports'] = '報表';
...
$string['scalestip2'] = '若要建立自訂的量尺，請點按課程管理選單的\"成績\"連結，然後選擇編輯->量尺。';
$string['schedule'] = '時程';
...
$string['showonly'] = '只顯示';
$string['showonlytopic'] = '只顯示第{$a}個主題';
$string['showonlyweek'] = '只顯示第{$a}週';
...
$string['showthishelpinlanguage'] = '以{$a}語言顯示輔助說明';
$string['since'] = '自從';
...
$string['sitefilesused'] = '課程中使用到的網站檔案';
...
$string['unusedaccounts'] = '當帳號{$a}天未使用則自動註銷退出課程。';
$string['unzip'] = '解壓縮';
...
$string['users'] = '用戶';
$string['usersnew'] = '新用戶';
$string['usersnoaccesssince'] = '顯示長時間未活動的用戶';
$string['userswithfiles'] = '用戶檔案';
$string['userzones'] = '用戶時區';
...
$string['welcometocourse'] = '歡迎到{$a}課程';
$string['welcometocoursetext'] = '歡迎進入{$a->coursename}課程!

您首先要做的第一件事是先增修個人資料，這樣我們才可以進一步了解您：
