<?PHP // $Id$ 
      // scorm.php - created with Moodle 1.9.4+ (Build: 20090401) (2007101545.01)
...
$string['autocontinuedesc'] = '活動預設情況下會自動繼續';
...
$string['popupblocked'] = '如果新視窗未顯示，{$a}';
$string['popupblockedlinkname'] = '點擊此處啟用該活動';
...
$string['scormloggingoff'] = 'API 日誌已關閉';
$string['scormloggingon'] = 'API 日誌已開啟';
