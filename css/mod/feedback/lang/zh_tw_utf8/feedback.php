...
$string['emailteachermail'] = '{$a->username}已完成回饋活動 : \"{$a->feedback}\"您可以在這裡查看它: {$a->url}';
$string['emailteachermailhtml'] = '{$a->username}已完成回饋活動 : <i>\"{$a-feedback}\"</i><br /><br /> 您可以在 <a href=\"{$a->url}\">這裡</a> 查看它.';
...
$string['importfromthisfile'] = '由此檔案匯入';
$string['info'] = '資訊';
$string['infotype'] = '資訊的類型';
$string['insufficient_responses_for_this_group'] = '不充足的回應';
$string['item_name'] = '問題';
$string['items_are_required'] = '星號標示的問題是一定要回答的。';
$string['label'] = '標籤';
$string['line_labels'] = '標籤';
$string['line_values'] = '評分';
$string['mapcourse'] = '對應課程';
$string['mapcourseinfo'] = '全域回饋單是所有課程可使用的回饋塊區塊。然而您可以藉由對映設限那些課程會顯示。搜尋課程並且將課程對映到回饋單。';
$string['mapcoursenone'] = '若沒有課程對映，則回饋單在所有課程都可以使用。';
$string['mapcourses'] = '將回饋單對映到課程';
$string['mappedcourses'] = '對映的課程';
$string['max_args_exceeded'] = '太多參數，最多只能處理6個參數。';
$string['maximal'] = '最大的';
$string['mode'] = '模式';
...
$string['this_feedback_is_already_submitted'] = '您已經完成這個活動。';
...
$string['are_you_sure_to_delete_this_entry'] = '您確定要刪除使用者的回應嗎？'; // ORPHANED
$string['are_you_sure_to_delete_this_item'] = '您確定要刪除這個項目嗎？'; // ORPHANED
$string['are_you_sure_to_delete_this_template'] = '您確定要刪除這個樣版嗎？'; // ORPHANED
$string['are_you_sure_to_use_this_template'] = '您確定要使用這個樣版嗎'; // ORPHANED
$string['feedback:deletecompleteds'] = '刪除完成'; // ORPHANED
