<?PHP // $Id: webquest.php,v 1.1.6.2 2007/02/02 18:48:33 stronk7 Exp $ webquest.php, [pt] library ,v 1.0 2007/01/16 12:00:00  darkath Exp $
...
$string['couldnotdelete'] = 'Não foi possível apagar o elemento selecionado';
...
$string['numbertasks'] = 'Número de tarefas a fazer';
...
$string['submissionend'] = 'Fim dos envíos';
$string['submissionstart'] = 'Início dos envíos';
$string['suggestedgrade'] = 'Nota sugerida';
$string['suretodelres'] = '¿Você tem certeza absoluta que quer apagar este recurso?';
$string['task'] = 'Tarefa';
...
$string['warningtask'] = 'Atenção: Já foram enviadas algumas avaliações. <br /> Não mude o número de tarefas, o tipo de escala ou os pesos das tarefas.';
