...
/// Print the page header
    ...
    print_header_simple(format_string($flv->name), "", get_string('flv', 'flv'), "", flv_print_header_js($flv), true, update_module_button($cm->id, $course->id, $strflv), navmenu($course, $cm));
