...
$string['flv'] = 'FLV Player';
$string['modulename'] = 'FLV Player';
$string['modulenameplural'] = 'FLV Players';
// Titles for mod/swf/mod_form.php sections
$string['flvname'] = 'Name';
$string['flvintro'] = 'Description';
//---------------------------------------------------------------------------------------------
// Labels for mod/flv/mod_form.php
//// Source
$string['flvsource'] = 'Video Source';
$string['flvfile'] = 'Video URL';
$string['hdfile'] = 'HD File (requires hd-1 plugin)';
$string['type'] = 'Type';
...
$string['flvid'] = 'ID (For Linux OS Users Only)';
