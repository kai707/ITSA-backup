<?php
    ...
    //urlencode($search)
    add_to_log($course->id, 'lightboxgallery', 'search', 'search.php?id=' . $course->id . '&l=' . $l . '&search=' . urlencode($search), $search, 0, $userid);
    ...
    print_header($heading, $course->fullname, $navigation, '', '<link rel="stylesheet" type="text/css" href="'.$CFG->wwwroot.'/mod/lightboxgallery/scripts/lightbox.css" />');
    ...
    //$SSS="%".htmlentities($search,ENT_QUOTES,'UTF-8')."%";
